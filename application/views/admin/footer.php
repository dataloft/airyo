    <div id="footer" class="navbar-default" role="navigation">
      <div class="container">
		...
		<div class="nav collapse navbar-collapse" id="bs-example-navbar-collapse-2">
			<p class="navbar-text navbar-right"><span class="glyphicon glyphicon-user"></span> <a href="/admin/settings" style="margin-right: 20px;">Андрей Цветков</a> <span class="glyphicon glyphicon-log-out"></span> <a href="/admin/logout">Выйти</a></p>
		</div>
		<?endif?>
