<div class="container">
    ...
    <?php endif; ?>
    <h1 class="page-header"><a href="/admin/groups" class="btn btn-info"><i class="glyphicon glyphicon-arrow-left"></i> Список групп</a> Группа<small> / редактирование</small></h1>
