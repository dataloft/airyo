<div class="container">
    ...
    <div class="form-group <?php if (form_error('url')) echo 'has-error"'; ?>">
        <label for="url" class="control-label">Описание группы</label>
	    <input type="text" class="form-control" id="name" name="name" value="<?=$group->description; ?>" placeholder="Описание группы">
    </div>
