	<div id="templatemo_main">
        ...
        <div id="sidebar" class="float_r">
        	<div class="sb_box">
                ...
                <ul class="sb_list">
                    <li><a href="#">От Темноты к Свету</a></li>
                </ul>
            </div>
            ...
            <div class="sb_box">
                ...
                <ul class="sb_list">
                    <li><a href="#">Внутренний ребенок - волшебный ребенок</a></li>
                    <li><a href="#">Внутренний ребенок - волшебный ребенок</a></li>
                </ul>
            </div>
            ...
            <div class="sb_box">
                ...
                <cite>Richard <a href="#"><span>- Senior Webmaster</span></a> <a href="http://nl.mystockphoto.com/free-photos/wrapping" title="onmiddellijke verpakking" class="sb_box_link"  target="_blank"><span>onmiddellijke verpakking</span></a></cite>
            </div>
        </div>
        <div class="cleaner"></div>
    </div>
