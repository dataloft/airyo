	<div id="templatemo_main">
        ...
        <div id="sidebar" class="float_r">
        	<div class="sb_box">
                <h3>Ближайший семинар</h3>
                <ul class="sb_list">
                    <li><a href="/seminar-shamanhealing">От Темноты к Свету</a></li>
                </ul>
            </div>
            
            <div class="sb_box">
                <h3>Прошедшие семинары</h3>
                <ul class="sb_list">
                    <li><a href="/seminar-child">Внутренний ребенок - волшебный ребенок</a></li>
                    <li><a href="/seminar-love">Любить себя</a></li>
                </ul>
            </div>
    ...
    <div id="templatemo_bottom">
    	...
    	<div class="col one_fourth last_box">
            ...
            <ul class="footer_link">
				...
				<li><a href="http://vk.com/shamanhealingufa" target="_blank"">vk.com/shamanhealingufa</a></li>
