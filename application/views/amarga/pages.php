	<div id="templatemo_slider">
        ...
        <div id="slider" class="nivoSlider">
            <img src="/themes/amarga/images/slider/01.jpg" alt="Slider 01" />
            <a href="#"><img src="/themes/amarga/images/slider/02.jpg" alt="Slider 02"/></a>
            <img src="/themes/amarga/images/slider/03.jpg" alt="Slider 03"/>
            <img src="/themes/amarga/images/slider/04.jpg" alt="Slider 04" />
        </div>
    ...
    <div id="templatemo_main">
    	<div class="col one_third">
            ...
            <p><a href="http://www.templatemo.com" rel="nofollow" target="_parent">Slate Theme</a> is free css template provided by <a href="http://www.templatemo.com" rel="nofollow" target="_parent">templatemo.com</a> for your personal or commercial websites. Credit goes to <a href="http://www.photovaco.com/" target="_blank">Free Photos</a> for photos. Duis dolor nisi, commodo eu auctor vehicula, condimentum quis risus. Nunc id lacus vel risus interdum mollis. Aenean leo ipsum, vulputate ac cursus eu, volutpat vel ante.</p>
        ...
        <div class="col one_third last_box">
        	<h2>Предыдущий семинар</h2>
            <img src="/themes/amarga/images/templatemo_image_01.jpg" alt="Image 01" class="image_frame" />
    	...
    	<div class="col one_fourth">
        	<h3>Медитируем</h3>
            <img src="/themes/amarga/images/templatemo_image_05.jpg" alt="Image 01" class="image_frame" />
        	Aliquam semper lacus a eros commodo vestibulum interdum mi pretium. Aliquam ac risus leo.
		</div>
        <div class="col one_fourth">
        	<h3>Танцуем</h3>
            <img src="/themes/amarga/images/templatemo_image_02.jpg" alt="Image 02" class="image_frame" />
        	Phasellus aliquet enim sed ligula faucibus nec tempus turpis bibendum. Duis vitae vel elit accumsan.
        </div>
        <div class="col one_fourth">
        	<h3>Рисуем</h3>
            <img src="/themes/amarga/images/templatemo_image_03.jpg" alt="Image 03" class="image_frame" />
        	Donec eleifend erat sed enim sodales tincidunt suscipit metus ornare inceptos himenaeos.
        </div>
        <div class="col one_fourth last_box">
        	<h3>Практикуем</h3>
            <img src="/themes/amarga/images/templatemo_image_04.jpg" alt="Image 04" class="image_frame" />
    ...
    <div id="templatemo_footer">
    	© 2014 Sunito
    	<div id="smartandy">Сделано в <a href="http://smartandy.ru">Smartandy</a> на <a href="http://smartandy.ru">Airyo</a></div>
    </div>