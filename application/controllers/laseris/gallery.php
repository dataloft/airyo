...
class Gallery extends Frontend {
	...
	public function index() {
		...
		//var_dump($this->oData["albums"]);
		//var_dump($aGalleryConfig);
		...
		foreach ($this->oData["albums"]  as $a)
		{
			//var_dump($a); 
			//echo $a->id;
			//$this->oData["albums"][$a->id] = $this->gallery_model->getFetchCountriesImages(array('sAlbumLabel' => $sAlbumLabel, 'iLimit' => $aPaginationConfig["per_page"], 'iStart' => $iPage));
